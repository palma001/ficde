...
import { modalitiesConfig, propsPanelEdition } from '../config/modalities'
  ...
  methods: {
    ...
    async updateNotes (data) {
      try {
        ...
        let response = await this.$services.putData(['ficde', this.entity, data.cod_modalidad], data)
    ...
    async deleteData (data) {
      try {
        this.loading = true
        this.loadingTable = true
        let res = await this.$services.deleteData(['ficde', this.entity, data.cod_modalidad])
