...
import { semestersConfig, propsPanelEdition } from '../config/semesters'
  ...
  methods: {
    ...
    async updateNotes (data) {
      try {
        ...
        let response = await this.$services.putData(['ficde', this.entity, data.cod_semestre], data)
    ...
    async deleteData (data) {
      try {
        this.loading = true
        this.loadingTable = true
        let res = await this.$services.deleteData(['ficde', this.entity, data.cod_semestre])
